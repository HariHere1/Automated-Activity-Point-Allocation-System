  ...
  return (
    <div className="min-h-screen page-wash">
      <header className="sticky top-0 z-30 glass-soft">
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-3 sm:px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            <button
              ...
              className="flex size-9 items-center justify-center rounded-md border border-border/70 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
            >
            ...
            <button
              ...
              className="flex size-9 items-center justify-center rounded-md border border-border/70 text-muted-foreground md:hidden"
            >
        ...
        {open && (
          <nav className="border-t border-border/60 px-4 pb-3 md:hidden">
            {NAV.map((item) => (
              <Link
                key={item.to}
                to={item.to}
                ...
                className="block rounded-md px-2 py-2 text-sm font-medium text-muted-foreground"
              >
                {item.label}
              </Link>
            ))}
